          ...
          child: Column(
            children: [
              ...
              TextFormField(
                ...
                validator: Validatorless.required('Singla obrigatória'),
                decoration: InputDecoration(
                  label: Text('Sigla'),
                ),
              ),
                ...
                children: [
                  Container(
                    ...
                    child: OutlinedButton(
                      ...
                      child: Text('Cancelar', style: context.textStyles.textExtraBold.copyWith(
                        color: Colors.red,
                      ),),
                    ),
                  ),
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () {
                        ...
                        if(valid){
                          ...
                          widget.controller.savePayment(id: widget.model?.id ,name: name, acronym: acronym, enabled: enabled);
                        }
                      },
